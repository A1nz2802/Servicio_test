...
// Ayuda a realizar peticiones a la ws
public class Helper {
    public static final String APP_NAME = "Viajes: ServiciosWeb";
    //public static final String BASE_URL_WS = "http://10.0.2.2:3000";
    public static final String BASE_URL_WS = "http://192.168.1.100:3010"; //IP DEL COMPUTADOR
